  ...
  return (
    <div className="form-card-new">
      ...
      <div className="form-row">
        <div className="copy-type-section-new">
          <label className="copy-type-label-new">Copy Type</label>
          <div className="copy-type-buttons-new">
            <button
              type="button"
              className={`copy-type-btn-new ${formData.copyType === 'soft' ? 'active' : ''}`}
              onClick={() => handleCopyTypeChange('soft')}
            >
              Soft Copy Only
            </button>
            <button
              type="button"
              className={`copy-type-btn-new ${formData.copyType === 'original' ? 'active' : ''}`}
              onClick={() => handleCopyTypeChange('original')}
            >
              Original Copy
            </button>
          </div>
      ...
      {formData.copyType === "original" && (
        <div className="form-row-two">
          <div className="form-field">
            <label className="copy-type-label-new">Return Date</label>
            <input
              type="date"
              className="form-input"
          ...
          <div className="form-field">
            <label className="copy-type-label-new">Priority</label>
            <select 
              className="form-select"
...
const QRCard = ({ userName = "John Doe", userId = "USER-001", filesAssigned = 0, filesToReturn = 0, onQRCodeClick }) => {
  ...
  return (
    <div className="qr-card-new">
      <h3 className="qr-card-title-new">Your QR Code</h3>
      <div 
        className="qr-code-wrapper-new" 
...
export const RequestPage = () => {
  ...
  return (
    <>
      <SidePanel />
      <div className="department-head-page" style={{ gridColumn: 'span 4' }}>
